...
/**
 * Client component — pose detection + session, kullanıcı etkileşimi.
 * id'yi server wrapper'dan alır, exercise'ı kendi lookup eder.
 */
export function ExerciseAnalyzerClient({ id }: { id: string }) {
